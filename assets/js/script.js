function createCityList(citySearchList) {
  ...
  function populateCityWeather(city, citySearchList) {
    ...
    var queryURL =
      "https://api.openweathermap.org/data/2.5/weather?&units=imperial&appid=27be5eaf78baf6d8d8bf43cfd9dbb859&q=" +
      city;
  
    var queryURL2 =
      "https://api.openweathermap.org/data/2.5/forecast?&units=imperial&appid=27be5eaf78baf6d8d8bf43cfd9dbb859&q=" +
      city;
    ...
    $.ajax({
      ...
      .then(function(weather) {
        ...
        var queryURL3 =
          "https://api.openweathermap.org/data/2.5/uvi/forecast?&units=imperial&appid=27be5eaf78baf6d8d8bf43cfd9dbb859&q=" +
          "&lat=" +
          latitude +
          "&lon=" +
          longitude;
